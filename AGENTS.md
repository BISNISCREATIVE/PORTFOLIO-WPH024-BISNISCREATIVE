...
#### Step 1: Plan your API endpoint and determine the required data structure

#### Step 2: Create a shared interface (Optional)

Create a shared interface in `shared/api.ts`:
